...
export const Invite = () => {
    ...
    const handleFinish = () => {
        form.validateFields().then((values: { playerId: string }) => {
        ...
        <>
            ...
            <FullscreenPage>
                <Flex vertical gap={'small'}>
                    ...
                    >
                        <Flex vertical gap={'small'}>
                            <Form.Item name="playerId" label="Joueur à inviter"
                            ...
                            <Button type="primary" htmlType="submit">Inviter</Button>
                        </Flex>
                    </Form>
                    {token &&
                        <Button
                            ...
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + ROUTES.REGISTER + '?invitation-token=' + token);
                                messageApi.open({
                                    type: 'success',
