    ...
    return (
        <FlexFullWidth vertical gap={'large'}>
            ...
            >
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <WrapperTeamSelection vertical team="1">
                            ...
                            <Form.Item name="joueurA1" label="Joueur 01"
                                       rules={[
                            ...
                            <Form.Item name="joueurA2" label="Joueur 02"
                                       rules={[
                                           {
                                               required: !!joueurB2,
                                               type: 'string',
                            ...
                            <Form.Item name="scoreA" label="Score"
                                       rules={[
                    ...
                    <Col span={12}>
                        <WrapperTeamSelection vertical team="2">
                            ...
                            <Form.Item name="joueurB1" label="Joueur 01"
                                       rules={[
                                           {required: true, type: 'string', message: 'Veuillez choisir un joueur'},
                                       ]}
                            >
                            ...
                            <Form.Item name="joueurB2" label="Joueur 02"
                                       rules={[
                                           {
                                               required: !!joueurA2,
                                               type: 'string',
                            ...
                            <Form.Item name="scoreB" label="Score"
                                       rules={[
                                           {required: true, type: 'number', message: 'Veuillez entrer un score'},
                                           {
                ...
                <Button type="primary" danger={createMatchMutate.isError} htmlType="submit"
